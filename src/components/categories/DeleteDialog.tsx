...
function DeleteDialog({
  ...
  if (!deleteState.open || !deleteState.category) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-xl p-6">
        ...
        <h3 className="text-base font-semibold text-gray-900 mb-1">Delete category</h3>
        <p className="text-sm text-gray-500 mb-6">
          Are you sure you want to delete{' '}
          <span className="font-medium text-gray-700">
            &ldquo;{deleteState.category.name}&rdquo;
          </span>
